...
class DatabaseConnection:
    def __init__(self, host='localhost', user='root', password='', database='python'):
        self.host = host
        self.user = user
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This App About Student Management System using Python and SQL DB.
        """
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        # student id for selected Row
        self.student_id = main_window.table.item(index, 0).text()

        # student name for selected Row
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        confirmation = QLabel("Are You sure to Deleted Record")
        yes = QPushButton("Yes")
        no = QPushButton("No")
